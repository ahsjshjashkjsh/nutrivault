...
const foods = [
  ...
  // ── Swiss Fresh Meat & Fish (butcher counter, per 100g raw) ──────────────────
  { name: "Schweinshalssteak", brand: "Generic", calories: 216, proteinG: 17.5, carbsG: 0.0, fatG: 16.0, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Bistecca di collo di maiale","de":"Schweinshalssteak","es":"Filete de aguja de cerdo","fr":"Steak de cou de porc","en":"Pork neck steak"}' },
  { name: "Schweinskotelett", brand: "Generic", calories: 196, proteinG: 19.5, carbsG: 0.0, fatG: 13.0, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Costoletta di maiale","de":"Schweinskotelett","es":"Chuleta de cerdo","fr":"Côtelette de porc","en":"Pork chop"}' },
  { name: "Schweinsgeschnetzeltes", brand: "Generic", calories: 143, proteinG: 21.0, carbsG: 0.0, fatG: 6.5, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Spezzatino di maiale","de":"Schweinsgeschnetzeltes","es":"Tiras de cerdo","fr":"Émincé de porc","en":"Pork strips"}' },
  { name: "Pouletbrust (roh)", brand: "Generic", calories: 110, proteinG: 23.0, carbsG: 0.0, fatG: 1.5, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Petto di pollo (crudo)","de":"Pouletbrust (roh)","es":"Pechuga de pollo (cruda)","fr":"Blanc de poulet (cru)","en":"Chicken breast (raw)"}' },
  { name: "Pouletschenkel (roh)", brand: "Generic", calories: 214, proteinG: 17.5, carbsG: 0.0, fatG: 15.5, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Coscia di pollo (cruda)","de":"Pouletschenkel (roh)","es":"Muslo de pollo (crudo)","fr":"Cuisse de poulet (crue)","en":"Chicken leg (raw)"}' },
  { name: "Kalbsschnitzel", brand: "Generic", calories: 107, proteinG: 20.5, carbsG: 0.0, fatG: 2.4, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Scaloppina di vitello","de":"Kalbsschnitzel","es":"Escalope de ternera","fr":"Escalope de veau","en":"Veal cutlet"}' },
  { name: "Kalbsgeschnetzeltes", brand: "Generic", calories: 112, proteinG: 20.7, carbsG: 0.0, fatG: 2.8, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Spezzatino di vitello","de":"Kalbsgeschnetzeltes","es":"Tiras de ternera","fr":"Émincé de veau","en":"Veal strips"}' },
  { name: "Rindsentrecôte", brand: "Generic", calories: 191, proteinG: 20.5, carbsG: 0.0, fatG: 12.0, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Entrecôte di manzo","de":"Rindsentrecôte","es":"Entrecot de res","fr":"Entrecôte de bœuf","en":"Beef entrecôte"}' },
  { name: "Rindshuft", brand: "Generic", calories: 135, proteinG: 21.5, carbsG: 0.0, fatG: 5.0, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Scamone di manzo","de":"Rindshuft","es":"Cadera de res","fr":"Rumsteck de bœuf","en":"Beef rump"}' },
  { name: "Lammkotelett", brand: "Generic", calories: 282, proteinG: 16.5, carbsG: 0.0, fatG: 23.5, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Costoletta di agnello","de":"Lammkotelett","es":"Chuleta de cordero","fr":"Côtelette d\'agneau","en":"Lamb chop"}' },
  { name: "Cervelat", brand: "Generic", calories: 275, proteinG: 12.5, carbsG: 1.5, fatG: 24.5, sugarG: 0.5, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Cervelat","de":"Cervelat","es":"Cervelat","fr":"Cervelas","en":"Cervelat sausage"}' },
  { name: "Wienerli", brand: "Generic", calories: 286, proteinG: 11.5, carbsG: 1.5, fatG: 26.0, sugarG: 0.5, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Würstel","de":"Wienerli","es":"Salchicha vienesa","fr":"Saucisse de Vienne","en":"Wiener sausage"}' },
  { name: "Landjäger", brand: "Generic", calories: 446, proteinG: 26.0, carbsG: 1.5, fatG: 37.0, sugarG: 0.5, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Landjäger","de":"Landjäger","es":"Landjäger","fr":"Landjäger","en":"Landjäger sausage"}' },
  { name: "Forelle (roh)", brand: "Generic", calories: 119, proteinG: 20.5, carbsG: 0.0, fatG: 3.5, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Trota (cruda)","de":"Forelle (roh)","es":"Trucha (cruda)","fr":"Truite (crue)","en":"Trout (raw)"}' },
  { name: "Eglifilet (roh)", brand: "Generic", calories: 91, proteinG: 18.5, carbsG: 0.0, fatG: 1.6, sugarG: 0.0, servingSize: 100, servingUnit: "g", source: "seed", nameTranslations: '{"it":"Filetto di pesce persico","de":"Eglifilet (roh)","es":"Filete de perca","fr":"Filet de perche","en":"Perch fillet (raw)"}' },
];
