...
export function DashboardHeader({ user }: DashboardHeaderProps) {
  ...
  return (
    <header className="app-header sticky top-0 z-30 flex min-h-16 items-center justify-between gap-2 px-3 py-2.5 sm:px-4 lg:px-8">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="app-profile flex items-center gap-2.5 rounded-xl p-1.5 sm:pr-2.5">
